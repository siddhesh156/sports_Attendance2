...
public class SecondActivity extends AppCompatActivity {
    ...
    public void edit(View view) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position,
                                    long id) {
                String uid = eUID.getText().toString(); //textView1.getText().toString();
                String name = eName.getText().toString(); //textView.getText().toString();
    ...
    public class SendRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                url = new URL("https://script.google.com/macros/s/AKfycbx3DxESSu-_22mc8WrJL7dX5YHg72Iwt7-_Fa7g1RqiQPJhWZk/exec");

                postDataParams = new JSONObject();

                String id = "1UyJylTNIWkWY50Fcp0GDGWLYXanCVpMAgqorqoDHmFY";
                ...
                Log.e("uid_name", adapter.getItem(q));
                q=q+1;
